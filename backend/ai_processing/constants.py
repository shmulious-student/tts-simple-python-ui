# Mapping from ISO 639-1 language codes (used by langdetect)
# to the language codes required by the facebook/mbart-large-50-many-to-many-mmt model.
MBART_LANG_MAP = {
...
# A smaller map for the languages we explicitly support as translation targets in the UI.
